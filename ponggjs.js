...
// Ball Object
var Ball = {
    new: function (canvas, incrementedSpeed) {
        return {
            width: 18,
            height: 18,
            x: (canvas.width / 2) - 9,
...
var Game = {
    ...
    draw: function () {
        ...
        this.context.fillText(rounds[Pong.round] || rounds[Pong.round - 1], this.canvas.width / 2, 100);
    },
    ...
    _resetTurn: function (victor, loser) {
        this.ball = Ball.new(this.canvas, this.ball.speed);
        this.turn = loser;
